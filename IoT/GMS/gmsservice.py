...
This module provides Services used by GMS units.
...
class GMS(Service):
    """
    Provide GMS-like functionality via the service.
    ...
    See ``examples/ble_gms_echo_test.py`` for a usage example.
    """

    # pylint: disable=no-member
    uuid = VendorUUID("00002220-0000-1000-8000-00805F9B34FB")
    _server_tx = StreamOut(
        uuid=VendorUUID("00002221-0000-1000-8000-00805F9B34FB"),
        timeout=3.0,
        buffer_size=256,
    )
    _server_rx = StreamIn(
        uuid=VendorUUID("00002222-0000-1000-8000-00805F9B34FB"),
        timeout=3.0,
        buffer_size=256,
    )
